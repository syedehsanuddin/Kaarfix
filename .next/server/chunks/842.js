...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1395);
/* harmony import */ var hey_listen__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3033);
/* harmony import */ var _PanSession_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(7632);
/* harmony import */ var _utils_lock_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7544);
/* harmony import */ var _utils_is_ref_object_mjs__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(1804);
/* harmony import */ var _events_use_pointer_event_mjs__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(737);
/* harmony import */ var _utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(8969);
/* harmony import */ var _render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(3233);
...
/* harmony import */ var _projection_utils_measure_mjs__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(6460);
/* harmony import */ var _events_event_info_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8148);
/* harmony import */ var _animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(1056);
/* harmony import */ var _projection_geometry_conversion_mjs__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(6117);
/* harmony import */ var _events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1756);
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(2453);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([tslib__WEBPACK_IMPORTED_MODULE_0__, _utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__, _animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_12__, _projection_utils_measure_mjs__WEBPACK_IMPORTED_MODULE_10__, _PanSession_mjs__WEBPACK_IMPORTED_MODULE_7__]);
([tslib__WEBPACK_IMPORTED_MODULE_0__, _utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__, _animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_12__, _projection_utils_measure_mjs__WEBPACK_IMPORTED_MODULE_10__, _PanSession_mjs__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__);
...
var VisualElementDragControls = /** @class */ (function () {
    ...
    VisualElementDragControls.prototype.start = function (originEvent, _a) {
        ...
        var onStart = function (event, info) {
            ...
            (_a = _this.visualElement.animationState) === null || _a === void 0 ? void 0 : _a.setActive(_render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_6__/* .AnimationType.Drag */ .r.Drag, true);
        };
        ...
        this.panSession = new _PanSession_mjs__WEBPACK_IMPORTED_MODULE_7__/* .PanSession */ .H(originEvent, {
    ...
    VisualElementDragControls.prototype.cancel = function () {
        ...
        (_b = this.visualElement.animationState) === null || _b === void 0 ? void 0 : _b.setActive(_render_utils_types_mjs__WEBPACK_IMPORTED_MODULE_6__/* .AnimationType.Drag */ .r.Drag, false);
    };
    VisualElementDragControls.prototype.updateAxis = function (axis, _point, offset) {
        ...
        if (this.constraints && this.constraints[axis]) {
            next = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .applyConstraints */ .qc)(next, this.constraints[axis], this.elastic[axis]);
        }
        axisValue.set(next);
    };
    VisualElementDragControls.prototype.resolveConstraints = function () {
        ...
        if (dragConstraints && (0,_utils_is_ref_object_mjs__WEBPACK_IMPORTED_MODULE_9__/* .isRefObject */ .I)(dragConstraints)) {
            if (!this.constraints) {
            ...
            if (dragConstraints && layout) {
                this.constraints = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .calcRelativeConstraints */ .vu)(layout.actual, dragConstraints);
            }
            else {
                this.constraints = false;
            }
        }
        this.elastic = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .resolveDragElastic */ .k0)(dragElastic);
        /**
        ...
        if (prevConstraints !== this.constraints &&
            ...
            (0,_projection_utils_each_axis_mjs__WEBPACK_IMPORTED_MODULE_5__/* .eachAxis */ .U)(function (axis) {
                if (_this.getAxisMotionValue(axis)) {
                    _this.constraints[axis] = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .rebaseAxisConstraints */ .QL)(layout.actual[axis], _this.constraints[axis]);
                }
            });
        }
    };
    VisualElementDragControls.prototype.resolveRefConstraints = function () {
        ...
        if (!constraints || !(0,_utils_is_ref_object_mjs__WEBPACK_IMPORTED_MODULE_9__/* .isRefObject */ .I)(constraints))
            return false;
        ...
        if (!projection || !projection.layout)
            return false;
        var constraintsBox = (0,_projection_utils_measure_mjs__WEBPACK_IMPORTED_MODULE_10__/* .measurePageBox */ .z)(constraintsElement, projection.root, this.visualElement.getTransformPagePoint());
        var measuredConstraints = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .calcViewportConstraints */ .ds)(projection.layout.actual, constraintsBox);
        /**
         * If there's an onMeasureDragConstraints listener we call it and
         * if different constraints are returned, set constraints to that
         */
        if (onMeasureDragConstraints) {
            var userConstraints = onMeasureDragConstraints((0,_projection_geometry_conversion_mjs__WEBPACK_IMPORTED_MODULE_11__/* .convertBoxToBoundingBox */ .z2)(measuredConstraints));
            this.hasMutatedConstraints = !!userConstraints;
            if (userConstraints) {
                measuredConstraints = (0,_projection_geometry_conversion_mjs__WEBPACK_IMPORTED_MODULE_11__/* .convertBoundingBoxToBox */ .i8)(userConstraints);
            }
        }
    ...
    VisualElementDragControls.prototype.startAxisValueAnimation = function (axis, transition) {
        var axisValue = this.getAxisMotionValue(axis);
        return (0,_animation_utils_transitions_mjs__WEBPACK_IMPORTED_MODULE_12__/* .startAnimation */ .b8)(axis, axisValue, 0, transition);
    };
    ...
    VisualElementDragControls.prototype.snapToCursor = function (point) {
        ...
        (0,_projection_utils_each_axis_mjs__WEBPACK_IMPORTED_MODULE_5__/* .eachAxis */ .U)(function (axis) {
            ...
            if (projection && projection.layout) {
                ...
                axisValue.set(point[axis] - (0,popmotion__WEBPACK_IMPORTED_MODULE_13__/* .mix */ .C)(min, max, 0.5));
            }
        });
    };
    /**
    ...
    VisualElementDragControls.prototype.scalePositionWithinConstraints = function () {
        ...
        var projection = this.visualElement.projection;
        if (!(0,_utils_is_ref_object_mjs__WEBPACK_IMPORTED_MODULE_9__/* .isRefObject */ .I)(dragConstraints) || !projection || !this.constraints)
            return;
        /**
        ...
        (0,_projection_utils_each_axis_mjs__WEBPACK_IMPORTED_MODULE_5__/* .eachAxis */ .U)(function (axis) {
            ...
            if (axisValue) {
                ...
                boxProgress[axis] = (0,_utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .calcOrigin */ .BD)({ min: latest, max: latest }, _this.constraints[axis]);
            }
        });
        /**
        ...
        (0,_projection_utils_each_axis_mjs__WEBPACK_IMPORTED_MODULE_5__/* .eachAxis */ .U)(function (axis) {
            ...
            axisValue.set((0,popmotion__WEBPACK_IMPORTED_MODULE_13__/* .mix */ .C)(min, max, boxProgress[axis]));
        });
    };
    VisualElementDragControls.prototype.addListeners = function () {
         ...
         */
        var stopPointerListener = (0,_events_use_pointer_event_mjs__WEBPACK_IMPORTED_MODULE_14__/* .addPointerEvent */ .a)(element, "pointerdown", function (event) {
            var _a = _this.getProps(), drag = _a.drag, _b = _a.dragListener, dragListener = _b === void 0 ? true : _b;
            drag && dragListener && _this.start(event);
        });
        var measureDragConstraints = function () {
            var dragConstraints = _this.getProps().dragConstraints;
            if ((0,_utils_is_ref_object_mjs__WEBPACK_IMPORTED_MODULE_9__/* .isRefObject */ .I)(dragConstraints)) {
         ...
         */
        var stopResizeListener = (0,_events_use_dom_event_mjs__WEBPACK_IMPORTED_MODULE_15__/* .addDomEvent */ .E)(window, "resize", function () {
    ...
    VisualElementDragControls.prototype.getProps = function () {
        ...
        var _a = props.drag, drag = _a === void 0 ? false : _a, _b = props.dragDirectionLock, dragDirectionLock = _b === void 0 ? false : _b, _c = props.dragPropagation, dragPropagation = _c === void 0 ? false : _c, _d = props.dragConstraints, dragConstraints = _d === void 0 ? false : _d, _e = props.dragElastic, dragElastic = _e === void 0 ? _utils_constraints_mjs__WEBPACK_IMPORTED_MODULE_8__/* .defaultElastic */ .xF : _e, _f = props.dragMomentum, dragMomentum = _f === void 0 ? true : _f;
...
/* harmony export */ });
/* harmony import */ var _gestures_use_focus_gesture_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9067);
/* harmony import */ var _gestures_use_hover_gesture_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6299);
/* harmony import */ var _gestures_use_tap_gesture_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4753);
/* harmony import */ var _utils_make_renderless_component_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5445);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_gestures_use_tap_gesture_mjs__WEBPACK_IMPORTED_MODULE_1__]);
_gestures_use_tap_gesture_mjs__WEBPACK_IMPORTED_MODULE_1__ = (__webpack_async_dependencies__.then ? await __webpack_async_dependencies__ : __webpack_async_dependencies__)[0];
...
var gestureAnimations = {
    tap: (0,_utils_make_renderless_component_mjs__WEBPACK_IMPORTED_MODULE_0__/* .makeRenderlessComponent */ .x)(_gestures_use_tap_gesture_mjs__WEBPACK_IMPORTED_MODULE_1__/* .useTapGesture */ .Q),
    focus: (0,_utils_make_renderless_component_mjs__WEBPACK_IMPORTED_MODULE_0__/* .makeRenderlessComponent */ .x)(_gestures_use_focus_gesture_mjs__WEBPACK_IMPORTED_MODULE_2__/* .useFocusGesture */ .r),
    hover: (0,_utils_make_renderless_component_mjs__WEBPACK_IMPORTED_MODULE_0__/* .makeRenderlessComponent */ .x)(_gestures_use_hover_gesture_mjs__WEBPACK_IMPORTED_MODULE_3__/* .useHoverGesture */ .L),
};
...
function createMotionComponent(_a) {
    ...
    function MotionComponent(props, externalRef) {
         ...
         */
        var context = (0,_context_MotionContext_create_mjs__WEBPACK_IMPORTED_MODULE_4__/* .useCreateMotionContext */ .H)(props, config.isStatic);
        /**
         ...
         */
        var projectionId = (0,_projection_node_id_mjs__WEBPACK_IMPORTED_MODULE_5__/* .useProjectionId */ ._)();
        /**
         *
         */
...
var makeUseVisualState = function (config) { return function (props, isStatic) {
    ...
    return isStatic
        ...
        : (0,_utils_use_constant_mjs__WEBPACK_IMPORTED_MODULE_4__/* .useConstant */ .h)(function () { return makeState(config, props, context, presenceContext); });
}; };
...
/* harmony export */ });
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2453);
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4710);
/* harmony import */ var popmotion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9326);
...
var parseDomVariant = function (visualElement, target, origin, transitionEnd) {
    ...
    return (0,_unit_conversion_mjs__WEBPACK_IMPORTED_MODULE_1__/* .unitConversion */ .d)(visualElement, target, origin, transitionEnd);
};
...
__webpack_require__.a(__webpack_module__, async (__webpack_handle_async_dependencies__) => {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "d": () => (/* binding */ unitConversion)
/* harmony export */ });
...
function buildSVGAttrs(state, _a, options, transformTemplate) {
    ...
    if (totalPathLength !== undefined && pathLength !== undefined) {
        (0,_path_mjs__WEBPACK_IMPORTED_MODULE_3__/* .buildSVGPath */ .c)(attrs, totalPathLength, pathLength, pathSpacing, pathOffset, false);
    }
}
            ...
            for (var key in allKeys) {
                ...
                if (next !== prev) {
                    ...
                    if ((0,_animation_utils_is_keyframes_target_mjs__WEBPACK_IMPORTED_MODULE_5__/* .isKeyframesTarget */ .C)(next) && (0,_animation_utils_is_keyframes_target_mjs__WEBPACK_IMPORTED_MODULE_5__/* .isKeyframesTarget */ .C)(prev)) {
                        if (!(0,_utils_shallow_compare_mjs__WEBPACK_IMPORTED_MODULE_6__/* .shallowCompare */ .V)(next, prev)) {
                            markToAnimate(key);
                        }
                        else {
                            /**
...
function setTarget(visualElement, definition) {
    ...
    var _a = resolved
        ...
        : {}, _b = _a.transitionEnd, transitionEnd = _b === void 0 ? {} : _b; _a.transition; var target = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__rest)(_a, ["transitionEnd", "transition"]);
...
/* harmony import */ var _utils_interpolate_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(862);
...
/* harmony import */ var framesync__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4735);
/* harmony import */ var _utils_interpolate_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(862);
...
const mixColor = (from, to) => {
    ...
    const mixFunc = fromColorType === hsla/* hsla */.J ? mix/* mix */.C : mixLinearColor;
    return (v) => {
